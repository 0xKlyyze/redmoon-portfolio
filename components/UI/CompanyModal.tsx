        ...
        <AnimatePresence>
            {isOpen && (
                <>
                    ...
                    >
                        <div className="pointer-events-auto w-full max-w-2xl max-h-[85vh] flex flex-col glass-panel-premium rounded-2xl md:rounded-3xl shadow-2xl">

                            {/* Close Button */}
                            <button
                                onClick={() => setOpen(false)}
                                className="absolute top-5 right-5 z-10 p-2 rounded-xl bg-white/5 hover:bg-white/10 text-white/40 hover:text-white transition-all duration-200 group"
                            >
                            ...
                            {isLoading ? (
                                ...
                                <>
                                    ...
                                    <div className="relative p-8 pb-6 text-center border-b border-white/[0.06]">
                                        ...
                                        {/* Animated Logo/Icon */}
                                        <motion.div
                                            className="relative w-24 h-24 mx-auto mb-6 rounded-2xl bg-gradient-to-br from-white/[0.03] to-white/[0.01] border border-white/10 flex items-center justify-center overflow-hidden hover-lift shadow-glow-subtle"
                                            animate={{
                                        ...
                                        >
                                            {companyInfo?.branding?.logo ? (
                                                ...
                                                <span className="text-4xl font-orbitron font-bold text-gradient-crimson drop-shadow-md">
                                                    {companyInfo?.companyName?.charAt(0) || 'R'}
                                                </span>
                                            )}
                                        </motion.div>

                                        <h2 className="font-orbitron text-2xl md:text-3xl font-bold text-white tracking-widest mb-2">
                                        ...
                                        {companyInfo?.foundedYear && (
                                            <span className="inline-block mt-4 px-3 py-1 text-[10px] font-mono text-tech-blue bg-tech-blue/10 border border-tech-blue/20 rounded-full">
                                    ...
                                    <div className="flex border-b border-white/[0.06] bg-black/20">
                                        {[
                                            ...
                                            <button
                                                ...
                                                className={`flex-1 px-4 py-4 text-xs md:text-sm font-medium transition-all relative flex items-center justify-center gap-2 ${activeSection === tab.id
                                                        ? 'text-white'
                                                        : 'text-white/40 hover:text-white/70 hover:bg-white/[0.02]'
                                                    }`}
                                            >
                                                <tab.icon className={`w-4 h-4 ${activeSection === tab.id ? 'text-redmoon-crimson' : ''}`} />
                                                <span className="tracking-wide uppercase font-orbitron text-[10px] md:text-xs">{tab.label}</span>
                                    ...
                                    {/* Content Area */}
                                    <div className="flex-1 overflow-y-auto custom-scrollbar p-6 lg:p-8 bg-black/10">
                                                ...
                                                >
                                                    ...
                                                    {companyInfo?.seo?.description && (
                                                        <div className="space-y-3">
                                                            <h4 className="text-[10px] font-mono text-white/30 uppercase tracking-[0.2em]">Overview</h4>
                                                    ...
                                                    {socialLinks.length > 0 && (
                                                        <div className="space-y-3">
                                                            <h4 className="text-[10px] font-mono text-white/30 uppercase tracking-[0.2em]">Connect</h4>
                                                            <div className="flex flex-wrap gap-3">
                                                                {socialLinks.map(([platform, url]) => (
                                                                    <a
                                                                        ...
                                                                        className="w-12 h-12 rounded-xl bg-white/[0.03] hover:bg-white/[0.08] border border-white/[0.06] hover:border-white/20 flex items-center justify-center transition-all group hover-lift"
                                                                        title={platform}
                                                                    >
                                                                        <SocialIcon name={platform} className="w-5 h-5 text-white/50 group-hover:text-white transition-colors" />
                                                                    </a>
                                                                ))}
                                                            </div>
                                                        </div>
                                                    ...
                                                    {(companyInfo?.branding?.primaryColor || companyInfo?.branding?.secondaryColor) && (
                                                        <div className="space-y-3">
                                                            <h4 className="text-[10px] font-mono text-white/30 uppercase tracking-[0.2em]">Brand Identity</h4>
                                                            <div className="flex gap-4">
                                                                {companyInfo.branding.primaryColor && (
                                                                    <div className="group flex items-center gap-3 p-2 pr-4 rounded-lg bg-white/[0.02] border border-white/[0.04]">
                                                                        <div
                                                    ...
                                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                        {companyInfo?.contact?.email && (
                                                            <a
                                                                ...
                                                                className="p-5 bg-white/[0.03] rounded-xl border border-white/[0.06] hover:border-tech-blue/50 hover:bg-tech-blue/[0.05] transition-all group"
                                                            >
                                                                <div className="w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center mb-3 text-white/40 group-hover:text-tech-blue group-hover:bg-tech-blue/10 transition-colors">
                                                                    <Icons.Mail className="w-4 h-4" />
                                                                </div>
                                                                <h4 className="text-[10px] font-mono text-white/40 uppercase tracking-wider mb-1">
                                                                    General Inquiries
                                                                </h4>
                                                                <p className="text-sm font-medium text-white group-hover:text-tech-blue transition-colors">
                                                                    {companyInfo.contact.email}
                                                                </p>
                                                            </a>
                                                        )}
                                                        ...
                                                        {companyInfo?.contact?.supportEmail && (
                                                            <a
                                                                ...
                                                                className="p-5 bg-white/[0.03] rounded-xl border border-white/[0.06] hover:border-neon-green/50 hover:bg-neon-green/[0.05] transition-all group"
                                                            >
                                                                <div className="w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center mb-3 text-white/40 group-hover:text-neon-green group-hover:bg-neon-green/10 transition-colors">
                                                        ...
                                                        {companyInfo?.contact?.phone && (
                                                            <a
                                                                ...
                                                                className="p-5 bg-white/[0.03] rounded-xl border border-white/[0.06] hover:border-solar-yellow/50 hover:bg-solar-yellow/[0.05] transition-all group md:col-span-2"
                                                            >
                                                                <div className="w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center mb-3 text-white/40 group-hover:text-solar-yellow group-hover:bg-solar-yellow/10 transition-colors">
                                                ...
                                                >
                                                    <div className="grid grid-cols-1 gap-3">
                                                        {[
                                                            ...
                                                            return (
                                                                <div key={key} className="p-4 bg-white/[0.03] rounded-xl border border-white/[0.06] hover:bg-white/[0.06] transition-all group flex items-center justify-between">
                                                                    ...
                                                                    {isUrl ? (
                                                                        <a
                                                                            ...
                                                                            target="_blank"
                                                                            rel="noopener noreferrer"
                                                                            className="px-3 py-1.5 rounded-lg bg-white/5 text-xs text-tech-blue hover:bg-tech-blue/10 transition-colors flex items-center gap-1.5"
                                                                        >
                                                                            <span>View</span>
                                                    ...
                                                    {!companyInfo?.legal?.privacyPolicy &&
                                                        ...
                                                        !companyInfo?.legal?.refundPolicy && (
                                                            <div className="flex flex-col items-center justify-center py-12 text-center">
                                                                <Icons.FileX className="w-12 h-12 text-white/10 mb-4" />
                                    ...
                                    {/* Footer */}
                                    <div className="p-4 border-t border-white/[0.06] text-center bg-black/20">
